...
public class TZ4_1cActivity extends Activity {
	...
	private ArrayList<Data> mDataList_origin=new ArrayList<TZ4_1cActivity.Data>();
	private ArrayList<Data> mDataList=new ArrayList<TZ4_1cActivity.Data>();
...
public void downloadsearch(String area11){
   ...
   http.send(HttpRequest.HttpMethod.POST,
  		 "http://josie.i3.com.hk/dishtag/json/m_my_friends.php",
           params,
...
private String FriendID;
	...
	*/							holder.mIv1 =(ImageView)convertView.findViewById(R.id.mIv1);
	...
	public void downloadsearch1(String area11){
	   ...
	   HttpUtils http = new HttpUtils();
	   http.send(HttpRequest.HttpMethod.POST,
	  		 "http://josie.i3.com.hk/dishtag/json/m_my_friends_del.php",
	           params,
	           new RequestCallBack<String>() {
					private String msg;
