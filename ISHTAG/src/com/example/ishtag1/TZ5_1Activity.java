...
public class TZ5_1Activity extends BaseActivity {
	...
	class Holder{
		TextView mTvattep,mTvri10,mTvri11,mTvri12,mty1,mTIvt41h,mTIvt41o1,mTIvt41o,mty2,mTIvt41k1,mTIvt41q,mTIvt41r,mTIvt41o1a;
	...
	class  Myadapter extends   BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			Holder holder = null;
			if(convertView==null){
				convertView = LayoutInflater.from(getApplicationContext()).inflate(R.layout.item_listview_t51, null);
				holder = new Holder();
...
*/				
              ...
              holder.mty2 =(TextView)convertView.findViewById(R.id.mty2);
              holder.mTIvt41k1 =(TextView)convertView.findViewById(R.id.mTIvt41k1);
              holder.mTIvt41q =(TextView)convertView.findViewById(R.id.mTIvt41q);
              holder.mTIvt41r =(TextView)convertView.findViewById(R.id.mTIvt41r);
              holder.mTIvt41o1a =(TextView)convertView.findViewById(R.id.mTIvt41o1a);
              holder.mTvattep =(TextView)convertView.findViewById(R.id.mTvattep);

  			holder.mty1.setTypeface (face1);
  			holder.mTIvt41h.setTypeface (face1);
  			holder.mTIvt41o1.setTypeface (face1);
  			holder.mTIvt41o.setTypeface (face1);
  			holder.mTvattep.setTypeface (face1);
  			
  			holder.mty2.setTypeface (face2);
  			holder.mTIvt41k1.setTypeface (face2);
  			holder.mTIvt41q.setTypeface (face2);
  			holder.mTIvt41r.setTypeface (face2);
  			holder.mTIvt41o1a.setTypeface (face2);
...
holder.imageView =(ImageView)convertView.findViewById(R.id.mTIvt41l);
			...
			holder.mRlt51a.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					startActivity(new Intent(getApplicationContext(), TZ5_1mpActivity.class));
				}
			});
