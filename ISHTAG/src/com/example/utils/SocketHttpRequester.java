...
public class SocketHttpRequester {
	...
	try {
		socket = new Socket(InetAddress.getByName(url.getHost()).getHostAddress(), port);
	 ...
	 * @throws Exception
	 */
	public int upoloadFile(String filePath,String str1,String str2,String str3,String str4,String str5) throws Exception {
			requestUrl = str5;//上传文件URL
			...
			params.put("Stitle", str1);
			params.put("Stext",str2);
			params.put("SPhotoNum",str3);
